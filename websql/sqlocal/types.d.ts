...
export type InputMessage = QueryMessage | TransactionMessage | FunctionMessage | ConfigMessage | DestroyMessage;
...
export type OutputMessage = SuccessMessage | ErrorMessage | DataMessage | CallbackMessage;
