...
function bAtTrelloHome() {
    ...
    if (url != "https://trello.com/" && url != "https://trello.com/u/"+user+"/boards")
        return false;
    return true;
}
...
function checkTryPro() {
    ...
    if (strDateNow == strDateLast)
        ...
        localStorage.setItem(PROP_LS_DATELASTTRYPROCHECK, strDateNow);
...
function handleStripePay(callbackIn) {
	...
	alert("Please write to support@plusfortrello.com for any license issues.\nWe have suspended the purchase of new licenses until further notice.");
	callback();
	return;
