...
export declare type AggregateFunctionOptions = FunctionOptions & {
    /**
...
export declare type BindableValue =
| SqlValue
/** Converted to NULL */
| undefined
...
export declare type BindingSpec =
 ...
 * `exec`
 */
export declare type ExecBaseOptions = Omit<
ExecOptions,
...
export declare type ExecReturnResultRowsOptions = {
    returnValue: 'resultRows';
};

export declare type ExecReturnSaveSqlOptions = {
    returnValue: 'saveSql';
};

export declare type ExecReturnThisOptions = {
    returnValue?: 'this';
};

export declare type ExecRowModeArrayOptions = {
    callback?: (row: SqlValue[]) => void | false;
    resultRows?: SqlValue[][];
    rowMode?: 'array';
};

export declare type ExecRowModeObjectOptions = {
    callback?: (row: { [columnName: string]: SqlValue }) => void | false;
    resultRows?: { [columnName: string]: SqlValue }[];
    rowMode: 'object';
};

export declare type ExecRowModeScalarOptions = {
    callback?: (row: SqlValue) => void | false;
    resultRows?: SqlValue[];
...
export declare type ExecRowModeStmtOptions = {
 ...
 * feature.
 */
export declare type FlexibleString =
| string
...
export declare type ListLike<T> = {
    length: number;
...
export declare type NullPointer = 0 | null | undefined;
...
export declare class OpfsSAHPoolDatabase extends OpfsDatabase {
...
export declare type SAHPoolUtil = {
...
export declare type ScalarFunctionOptions = FunctionOptions & {
...
export declare class sqlite3_file extends SQLiteStruct {
...
export declare class sqlite3_index_constraint extends SQLiteStruct {
    iColumn: number;
    op: number;
    usable: number;
    iTermOffset: number;
...
export declare class sqlite3_index_constraint_usage extends SQLiteStruct {
    argvIndex: number;
    omit: number;
...
export declare class sqlite3_index_info extends SQLiteStruct {
    nConstraint: number;
...
export declare class sqlite3_index_orderby extends SQLiteStruct {
    iColumn: number;
    desc: number;
...
export declare class sqlite3_io_methods extends SQLiteStruct {
    iVersion: number;
...
export declare class sqlite3_module extends SQLiteStruct {
    iVersion: number;
...
export declare class sqlite3_vfs extends SQLiteStruct {
    $iVersion: number;
    $szOsFile: number;
    $mxPathname: number;
    pNext: WasmPointer;
...
export declare class sqlite3_vtab extends SQLiteStruct {
    pModule: WasmPointer;
    nRef: number;
    zErrMsg: WasmPointer;
...
export declare class sqlite3_vtab_cursor extends SQLiteStruct {
    pVtab: WasmPointer;
 ...
 */
export declare function sqlite3InitModule(opts?: InitOptions): Promise<Sqlite3Static>;

export declare type Sqlite3Method = 'get' | 'all' | 'run' | 'values';

export declare type Sqlite3Static = {
...
export declare type SQLiteDataType =
| CAPI['SQLITE_INTEGER']
| CAPI['SQLITE_FLOAT']
| CAPI['SQLITE_TEXT']
| CAPI['SQLITE_BLOB']
...
export declare class SQLiteStruct {
    /**
...
export declare type StructPtrMapper<T> = {
    StructType: T;
    /**
...
export declare type WindowFunctionOptions = FunctionOptions & {
    /**
