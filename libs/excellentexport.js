 ...
 *
 * Modified by Zig Mandel to adapt to a Chrome extension
 */
...
(function (global) {
    ...
    var ExcellentExport = (function () {
        ...
        function createDownloadLink(anchor, base64data, exporttype, filename) {
            var blob;
            //MODIFIED BY ZIG FOR CHROME EXTENSION
            if (window.URL.createObjectURL) {
                ...
                a.dataset.downloadurl = [exporttype, a.download, a.href].join(':');
        ...
        var ee = {
            ...
            excel: function (anchor, table, name) {
                ...
                return createDownloadLink(anchor, b64, 'application/vnd.ms-excel', 'report-plusfortrello.xls');
            },
            csv: function (anchor, table, delimiter, newLine) {
                ...
                return createDownloadLink(anchor, b64, 'application/csv', 'report-plusfortrello.csv');
            }
        };
